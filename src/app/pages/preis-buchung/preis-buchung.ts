    ...
    <section aria-labelledby="preise-title">
      <mat-card>
        ...
        <ul>
          ...
          <li>Wochenpauschale (ab 7 Übernachtungen): <strong>64,00 €</strong>/Nacht = <strong>448,00 €</strong></li>
        </ul>
        <h2>Zwei Personen:</h2>
        <ul>
          <li>pro Übernachtung ab 5 Nächten: <strong>70,00 €</strong>/Nacht</li>
          <li>Wochenpauschale (ab 7 Übernachtungen): <strong>67,00 €</strong>/Nacht = <strong>469,00 €</strong></li>
        </ul>
        <p class="center"><strong>Preis für weniger Übernachtungen bzw. für längere Aufenthalte ist auf Anfrage jederzeit möglich.</strong></p>
        <mat-divider></mat-divider>
        ...
        <p>Nichtraucherappartement<br>
        Allergiebetten, keine Haustiere<br>
        Waschmaschinen- und Trocknernutzung ist nach Absprache möglich.</p>
        <mat-divider></mat-divider>
        ...
        <p>Es gelten unsere <a href="/assets/AGB.pdf" target="_blank" rel="noopener">Allgemeinen Geschäftsbedingungen</a></p>
        <mat-divider></mat-divider>
        <h2>Zahlungsart</h2>
